...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 11, 2022 at 12:26 PM
...
(2, 'Membuat API', 1, '2021-06-06 21:36:42', '2021-06-06 21:36:42'),
(3, 'Membuat API part 2', 1, '2021-06-07 20:59:43', '2021-06-07 20:59:43');
...
CREATE TABLE `courses` (
  ...
  `level` enum('all-level','beginner','intermediate','advance') COLLATE utf8mb4_unicode_ci NOT NULL,
  `description` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'Node js', 1, NULL, 'free', 'published', 0, 'beginner', 'ini kelas oke', 1, '2021-06-06 00:51:44', '2021-06-18 00:50:04'),
(3, 'Kelas Javascript', 1, NULL, 'free', 'draft', 0, 'beginner', NULL, 1, '2021-06-08 00:09:10', '2021-06-08 00:09:10');
...
INSERT INTO `creators` (`id`, `name`, `profile`, `email`, `profession`, `created_at`, `updated_at`) VALUES
(1, 'ilham akbar', 'http://myimages.com', 'ilhamakbar@gmail.com', 'perawat 1', '2021-06-20 22:15:47', '2021-06-20 22:15:47');
...
--
-- Table structure for table `image_courses`
--
...
(2, 'Instal Node.js 2', 'vd1', 2, '2021-06-10 21:34:00', '2021-06-10 21:34:00');
...
(1, 'bbyi', 'http://localhost:8000/images/1621067479844.png', 'b@gmail.com', 'Dev', '2021-06-04 07:08:24', '2021-06-05 01:17:39'),
(3, 'ilham akbar', 'http://myimages.com', 'ilhamakbar@gmail.com', 'backend dev', '2021-06-11 01:58:34', '2021-06-11 01:58:34');
...
(34, '2021_06_04_044409_create_mentors', 1),
(35, '2021_06_04_044644_create_courses', 2),
(43, '2021_06_04_044841_create_chapters', 3),
(44, '2021_06_04_045005_create_lessons', 3),
(45, '2021_06_04_065652_create_my_courses', 4),
(47, '2021_06_04_072505_create_image_courses', 5),
(48, '2021_06_04_073234_create_reviews', 6),
(50, '2021_06_21_042541_create_creators', 7),
(51, '2021_06_21_043103_create_blogs', 8),
(53, '2021_06_21_044356_create_image_blogs', 9);
...
(1, 1, 4, '2021-06-09 20:19:09', '2021-06-09 20:19:09'),
(2, 1, 6, '2021-06-09 20:19:36', '2021-06-09 20:19:36'),
(3, 1, 7, '2021-06-09 20:22:27', '2021-06-09 20:22:27'),
(4, 1, 8, '2021-06-09 20:23:03', '2021-06-09 20:23:03'),
(5, 1, 9, '2021-06-09 20:23:57', '2021-06-09 20:23:57'),
(6, 1, 10, '2021-06-13 21:21:18', '2021-06-13 21:21:18');
...
INSERT INTO `reviews` (`id`, `user_id`, `course_id`, `rating`, `note`, `created_at`, `updated_at`) VALUES
(3, 5, 1, 1, 'kurang oke', '2021-06-10 21:07:54', '2021-06-10 21:09:21'),
(4, 6, 1, 3, 'oke', '2021-06-10 21:09:41', '2021-06-10 21:09:41'),
(5, 10, 1, 5, NULL, '2021-06-14 19:15:07', '2021-06-14 19:15:07');
...
--
-- Indexes for table `image_courses`
--
ALTER TABLE `image_courses`
  ADD PRIMARY KEY (`id`),
  ADD KEY `image_courses_course_id_foreign` (`course_id`);
...
ALTER TABLE `my_courses`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `my_courses_course_id_user_id_unique` (`course_id`,`user_id`);
...
ALTER TABLE `reviews`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `reviews_course_id_user_id_unique` (`course_id`,`user_id`);
...
--
-- AUTO_INCREMENT for table `image_courses`
--
ALTER TABLE `image_courses`
...
--
ALTER TABLE `blogs`
  ADD CONSTRAINT `blogs_creator_id_foreign` FOREIGN KEY (`creator_id`) REFERENCES `creators` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `courses`
  ADD CONSTRAINT `courses_mentor_id_foreign` FOREIGN KEY (`mentor_id`) REFERENCES `mentors` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `image_blogs`
--
ALTER TABLE `image_blogs`
  ADD CONSTRAINT `image_blogs_blog_id_foreign` FOREIGN KEY (`blog_id`) REFERENCES `blogs` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `image_courses`
--
ALTER TABLE `image_courses`
  ADD CONSTRAINT `image_courses_course_id_foreign` FOREIGN KEY (`course_id`) REFERENCES `courses` (`id`) ON DELETE CASCADE;
